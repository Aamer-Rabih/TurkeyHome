            ...
            <div class="col-lg-12">
                <div class="card table-cards color-grey">
                    <div class="card-body table-hover">
                        ...
                        <h4 style="display:inline;">{{$course->title}} :</h4>
                            @if(!$course->active)
                            <form action="{{ route('course.activate', $course) }}" method="POST" id="makeActiveForm" style="display:inline; margin-right:10px;">
                                    {!! csrf_field() !!}
