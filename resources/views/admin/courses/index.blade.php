                ...
                <td>
                  <div class="operations delete">
                    <form action="{{ route('course.destroy', $course) }}" method="POST" id="deleteForm">
                      ...
                      <button id="button{{$course->id}}" class=" btn-xs delete-button" style="display:none;"></button>
                      <a herf="javascript:;" id="a{{$course->id}}" onclick="sweetAlert('a{{$course->id}}', 'button{{$course->id}}')" >
