          ...
          <table class="table table-bordered table-hover table-width">
            ...
            <tbody>
              ...
              <tr>
                ...
                @if($deneme->active)
                <td class="operations">
                  <form action="{{ route('deneme.deactivate', $deneme) }}" method="POST" id="deactivateForm">
                    {!! csrf_field() !!}
                ...
                <td>
                  <div class="operations delete">
                    <form action="{{ route('deneme.destroy',['class' => $deneme->id]) }}" method="POST" id="deleteForm">
                      {!! csrf_field() !!}
                      <input type="hidden" name="_method" value="DELETE">    
                      <button id="button{{$deneme->id}}" class=" btn-xs delete-button" style="display:none;"></button>
                      <a herf="javascript:;" id="a{{$deneme->id}}" onclick="sweetAlert('a{{$deneme->id}}', 'button{{$deneme->id}}')" >
