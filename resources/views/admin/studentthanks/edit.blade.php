              ...
              <form action="{{route('studentthank.update', $studentThank)}}" enctype="multipart/form-data" method="POST">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control form-control-select mt-3" id="typeField" name="type">
                    <option value="img" {{$studentThank->type === 'img' ? "selected" : "" }}>صورة</option>
                    <option value="video" {{$studentThank->type === 'video' ? "selected" : "" }}>فيديو</option>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control form-control-select mt-3" id="orderField" name="order">                   
                    ...
                    <option value="{{$order}}" {{$studentThank->order === $order ? "selected" : ""}}>{{$order}}</option>
                    @endforeach 
                  </select>
                </div>
